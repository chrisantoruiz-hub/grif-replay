...
extern void close_ic_sum_vs_dssd_efront_file(void);
extern void close_ic_sum_vs_dssd_efront_c_file(void);
...
void sort_main(Sort_status *arg)
{
   ...
   close_ic_sum_file();
   close_ic_sum_c_file();
   close_ic_sum_vs_dssd_efront_file();
   close_ic_sum_vs_dssd_efront_c_file();
